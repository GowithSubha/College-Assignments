...
int stack[100]; // declare a global stack array
...
int main()
{
    char exp[100];       // declare an array to store the prefix expression
    ...
    scanf("%s", exp); // read the prefix expression from the user
    printf("\n");
    ...
    { // repeat until the end of the expression is reached
        ...
        {                              // if the scanned character is an operator
            ...
            n3 = evaluate(*e, n1, n2); // evaluate the operator on the operands
